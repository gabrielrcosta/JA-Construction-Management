...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: "#1a1c1f", borderWidth: 1, borderColor: "#2a2d32", borderRadius: 12, padding: 24, alignItems: "center", gap: 8 },
  ...
  roleBadge: { backgroundColor: "rgba(245,158,11,0.12)", borderWidth: 1, borderColor: "rgba(245,158,11,0.3)", borderRadius: 4, paddingHorizontal: 10, paddingVertical: 4, marginTop: 4 },
  roleText: { color: "#f59e0b", fontSize: 11, fontWeight: "600", letterSpacing: 1.5 },
  logoutBtn: { backgroundColor: "#1a1c1f", borderWidth: 1, borderColor: "#ef4444", borderRadius: 8, padding: 14, alignItems: "center" },
